...
from obstacle import Desk, NPC, NPC_Still, Item
from map import Carpet, GoldenMapTile, Wall
...
def run_game():
	...
	gf.build_map(settings, screen, level_map, obstacles, map_entities, tile_list)
	...
	while True:
		...
		if settings.game_state == "main menu":
			...
			gf.update_player(settings, screen, player, display_box, tile_list)
